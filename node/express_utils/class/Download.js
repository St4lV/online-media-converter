...
class Download {
    ...
    async start(){
		...
		const command = (`../yt-dlp-master/./yt-dlp.sh -P ../node/downloaded ${this.url} --js-runtimes node --remote-components ejs:github -f ${format} -t ${codec} --embed-metadata`+" --cookies-from-browser firefox").toString();
